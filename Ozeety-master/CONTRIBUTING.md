Contributing to OZEETY Core
============================

The OZEETY Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ozeety-project/ozeety/blob/master/doc/translation_process.md)
...
The following applies to code changes to the OZEETY Core project, and is not to be
confused with overall OZEETY Network Protocol consensus changes.

Whether a pull request is merged into OZEETY Core rests with the project merge
...
Patches that change OZEETY consensus rules are considerably more involved than
...
Where a patchset proposes to change the OZEETY consensus, it must have been
...
The project leader is the release manager for each OZEETY Core release.
