...
static const unsigned int MAX_ESHADOW_TX_SIZE = 150000;
...
/** Global variable that points to the eshadow database (protected by cs_main) */
extern CEshadowDB* eshadowDB;
