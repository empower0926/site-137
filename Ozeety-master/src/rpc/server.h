...
extern UniValue DoEzeeSpend(const CAmount nAmount, std::vector<CEshadowMint>& vMintsSelected, std::string address_str);
...
extern UniValue geteshadowbalance(const JSONRPCRequest& request);
extern UniValue listmintedeshadows(const JSONRPCRequest& request);
extern UniValue listspenteshadows(const JSONRPCRequest& request);
extern UniValue listeshadowamounts(const JSONRPCRequest& request);
extern UniValue minteshadow(const JSONRPCRequest& request);
extern UniValue spendeshadow(const JSONRPCRequest& request);
extern UniValue spendraweshadow(const JSONRPCRequest& request);
extern UniValue spendeshadowmints(const JSONRPCRequest& request);
extern UniValue resetminteshadow(const JSONRPCRequest& request);
extern UniValue resetspenteshadow(const JSONRPCRequest& request);
extern UniValue getarchivedeshadow(const JSONRPCRequest& request);
extern UniValue importeshadows(const JSONRPCRequest& request);
extern UniValue exporteshadows(const JSONRPCRequest& request);
extern UniValue reconsidereshadows(const JSONRPCRequest& request);
extern UniValue getspenteshadowamount(const JSONRPCRequest& request);
extern UniValue setezeeseed(const JSONRPCRequest& request);
extern UniValue getezeeseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdezee(const JSONRPCRequest& request);
extern UniValue dezeestate(const JSONRPCRequest& request);
...
extern UniValue createraweshadowspend(const JSONRPCRequest& request);
