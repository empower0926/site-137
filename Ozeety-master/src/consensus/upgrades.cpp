...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        ...
        {
                /*.strName =*/ "Eshadow",
                /*.strInfo =*/ "EShadow protocol activation - start block v4",
        },
        {
                /*.strName =*/ "Eshadow_v2",
                /*.strInfo =*/ "new eshadow serials and zPOS start",
        },
        {
                /*.strName =*/ "BIP65",
        ...
        {
                /*.strName =*/ "Eshadow_Public",
                /*.strInfo =*/ "activation of eshadow public spends (spend v3)",
        },
        {
                /*.strName =*/ "OZEETY_v3.4",
        ...
        {
                /*.strName =*/ "v5_dummy",
                /*.strInfo =*/ "Placeholder for future OZEETY version 5.0 upgrade",
        },
        {
                /*.strName =*/ "Test_dummy",
