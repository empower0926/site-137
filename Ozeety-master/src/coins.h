...
/** 
    ...
    ****Note - for OZEETY we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    {
        return (nPos < vout.size() && !vout[nPos].IsNull() && !vout[nPos].IsEshadowMint());
    }
...
public:
    ...
    /** 
     * Amount of ozeety coming in to a transaction
