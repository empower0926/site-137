...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::EshadowMint ||
                record.type == TransactionRecord::EshadowSpend ||
                record.type == TransactionRecord::EshadowSpend_Change_eZee ||
                record.type == TransactionRecord::EshadowSpend_FromMe);
    }
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeEZEE || rec->type == TransactionRecord::MNReward) {
