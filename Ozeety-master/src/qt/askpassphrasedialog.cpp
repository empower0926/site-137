...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            OZEETYGUI* window = static_cast<OZEETYGUI*>(parentWidget());
...
{
    OZEETYGUI* gui = static_cast<OZEETYGUI*>(parentWidget());
...
{
    hide();
    static_cast<OZEETYGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("OZEETY will close now to finish the encryption process. "
