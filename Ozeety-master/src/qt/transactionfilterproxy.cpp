...
bool TransactionFilterProxy::isOrphan(const int status, const int type)
{
    return ( (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint ||
            type == TransactionRecord::StakeEZEE || type == TransactionRecord::MNReward)
...
bool TransactionFilterProxy::isZcTx(int type) const {
    return (type == TransactionRecord::EshadowMint || type == TransactionRecord::EshadowSpend || type == TransactionRecord::EshadowSpend_Change_eZee
            || type == TransactionRecord::EshadowSpend_FromMe || type == TransactionRecord::RecvFromEshadowSpend);
}

bool TransactionFilterProxy::isStakeTx(int type) const {
    return type == TransactionRecord::StakeMint || type == TransactionRecord::Generated || type == TransactionRecord::StakeEZEE || type == TransactionRecord::StakeDelegated;
}
