...
#include "qt/ozeety/furabstractlistitemdelegate.h"
#include "qt/ozeety/txviewholder.h"
#include "qt/ozeety/tooltipmenu.h"
#include "qt/ozeety/sendmultirow.h"
#include "qt/ozeety/coldstakingmodel.h"
#include "qt/ozeety/contactsdropdown.h"
#include "qt/ozeety/addressholder.h"
...
public:
    explicit ColdStakingWidget(OZEETYGUI* parent);
    ~ColdStakingWidget();
