...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, OZEETYGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, OZEETYGUI* gui, double posX = 3);
