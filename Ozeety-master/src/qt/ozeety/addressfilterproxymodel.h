...
#ifndef OZEETY_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define OZEETY_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //OZEETY_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
