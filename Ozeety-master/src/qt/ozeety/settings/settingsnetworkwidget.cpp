...
#include "qt/ozeety/settings/settingsnetworkwidget.h"
#include "qt/ozeety/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ozeety/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OZEETYGUI* _window, QWidget *parent) :
