...
#include "qt/ozeety/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(OZEETYGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &OZEETYGUI::openFAQ);
