...
#include "qt/ozeety/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ozeety/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OZEETYGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OZEETYGUI::handleRestart()
