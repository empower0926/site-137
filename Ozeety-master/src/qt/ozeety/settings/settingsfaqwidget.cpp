...
#include "qt/ozeety/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ozeety/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(OZEETYGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableOZTG,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableOZTG,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableOZTG,
    ...
    connect(ui->pushButton_UnspendableOZTG, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableOZTG);});
    ...
    if (parent)
        connect(parent, &OZEETYGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
