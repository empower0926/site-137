...
#include "qt/ozeety/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(OZEETYGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("OZEETY_tx_csv_export(*.csv)") : tr("OZEETY_addresses_csv_export(*.csv)"),
                                        nullptr);
