...
#include "qt/ozeety/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ozeety/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(OZEETYGUI* _window, QWidget *parent) :
