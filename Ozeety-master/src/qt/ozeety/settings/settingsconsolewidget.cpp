...
#include "qt/ozeety/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ozeety/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OZEETYGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OZEETY RPC console.") + "<br>" +
