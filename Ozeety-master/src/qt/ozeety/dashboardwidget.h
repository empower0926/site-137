...
#include "config/ozeety-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalOztg = 0;
    qint64 totalEzee = 0;
    QList<qreal> valuesOztg;
    QList<qreal> valueseZee;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(OZEETYGUI* _window);
    ~DashboardWidget();
