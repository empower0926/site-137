...
#include "qt/ozeety/sendcustomfeedialog.h"
#include "qt/ozeety/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(OZEETYGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &OZEETYGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
