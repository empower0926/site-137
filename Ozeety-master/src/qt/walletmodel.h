...
#ifndef OZEETY_QT_WALLETMODEL_H
#define OZEETY_QT_WALLETMODEL_H
...
/** Interface to OZEETY wallet from Qt view code. */
...
public:
    ...
    CAmount getEshadowBalance() const;
...
private:
    ...
    CAmount cachedEshadowBalance;
    CAmount cachedUnconfirmedEshadowBalance;
    CAmount cachedImmatureEshadowBalance;
