...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(OZTG);
    unitlist.append(mOZTG);
    unitlist.append(uOZTG);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case OZTG:
        return QString("ozeety");
    case mOZTG:
        return QString("mozeety");
    case uOZTG:
        return QString::fromUtf8("uozeety");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isEzee)
{
    QString CURR_UNIT = QString(CURRENCY_UNIT.c_str());
    QString z = "";
    if(isEzee) z = "z";
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isEZEE)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isEZEE);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isEZEE)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isEZEE));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
