...
#ifndef OZEETY_DETERMINISTICMINT_H
#define OZEETY_DETERMINISTICMINT_H
...
public:
    ...
    libeshadow::CoinDenomination GetDenomination() const { return denom; }
    ...
    void SetDenomination(const libeshadow::CoinDenomination denom) { this->denom = denom; }
...
#endif //OZEETY_DETERMINISTICMINT_H
