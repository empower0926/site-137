...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ozeety Core ozeety-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ozeety-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ozeety transaction") + "\n" +
                               "  ozeety-tx [options] -create [commands]   " + _("Create hex-encoded ozeety transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ozeety transaction
