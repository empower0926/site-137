...
public:
    ...
    bool IsEshadowSpend() const;
    bool IsEshadowPublicSpend() const;
...
public:
    ...
    bool HasEshadowSpendInputs() const;
    bool HasEshadowPublicSpendInputs() const;

    bool HasEshadowMintOutputs() const;

    bool ContainsEshadows() const
    {
        return HasEshadowSpendInputs() || HasEshadowMintOutputs();
    }

    CAmount GetEshadowSpent() const;

    bool IsCoinBase() const
    {
        return (vin.size() == 1 && vin[0].prevout.IsNull() && !ContainsEshadows());
    }
