...
///
/// \brief      Parameter manipulation routines for the Eshadow cryptographic
///             components.
///
...
/// \brief Fill in a set of Eshadow parameters from a modulus "N".
...
void
CalculateParams(EshadowParams &params, CBigNum N, std::string aux, uint32_t securityLevel)
{
