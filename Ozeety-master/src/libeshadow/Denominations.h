...
const std::vector<CoinDenomination> eshadowDenomList = {ZQ_ONE, ZQ_FIVE, ZQ_TEN, ZQ_FIFTY, ZQ_ONE_HUNDRED, ZQ_FIVE_HUNDRED, ZQ_ONE_THOUSAND, ZQ_FIVE_THOUSAND};
...
int64_t EshadowDenominationToAmount(const CoinDenomination& denomination);
CoinDenomination IntToEshadowDenomination(int64_t amount);
CoinDenomination AmountToEshadowDenomination(int64_t amount);
