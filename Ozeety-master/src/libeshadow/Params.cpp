...
* @file       Params.cpp
*
* @brief      Parameter class for Eshadow.
*
...
EshadowParams::EshadowParams(CBigNum N, uint32_t securityLevel) {
    ...
    CalculateParams(*this, N, ESHADOW_PROTOCOL_VERSION, securityLevel);
