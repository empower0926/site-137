 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator class for the Eshadow library.
 *
...
public:
    ...
    template<typename Stream>
    Accumulator(const EshadowParams* p, Stream& strm)
    {
        strm >> *this;
    ...
    Accumulator(const EshadowParams* p, const CoinDenomination d, CBigNum bnValue = 0);
