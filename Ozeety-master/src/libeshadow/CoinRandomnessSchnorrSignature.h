...
public:
     ...
     *
     * @param zcparams eshadow params (group modulus, order and generators)
     ...
     */
    CoinRandomnessSchnorrSignature(const EshadowParams* zcparams, const CBigNum randomness, const uint256 msghash);
     ...
     * @return
     */
    bool Verify(const EshadowParams* zcparams, const CBigNum& S, const CBigNum& C, const uint256 msghash) const;
