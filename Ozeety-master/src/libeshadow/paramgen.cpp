 ...
 * @file       paramgen.cpp
 *
 * @brief      Parameter generation utility for Eshadow.
 *
...
PrintWarning()
{
    cout << "Eshadow parameter generation utility" << endl;
    cout << "-------------------------------------" << endl << endl;
    ...
    cout << endl;
    cout << "SECURITY WARNING: ESHADOW PARAMETERS MUST BE GENERATED BY" << endl;
