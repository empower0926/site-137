...
#ifndef OZEETY_STAKEINPUT_H
#define OZEETY_STAKEINPUT_H
...
public:
    ...
    virtual bool IsEZEE() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class COztgStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsEZEE() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //OZEETY_STAKEINPUT_H
