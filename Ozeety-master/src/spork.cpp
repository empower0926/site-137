...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 OZTG
    ...
    MAKE_SPORK_DEF(SPORK_16_ESHADOW_MAINTENANCE_MODE,      4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_18_ESHADOW_PUBLICSPEND_V4,        4070908800ULL), // OFF
};
...
// OZEETY: on startup load spork values from previous session if they exist in the sporkDB
