...
const char* GetOpName(opcodetype opcode)
{
    ...
    // eshadow
    case OP_ESHADOWMINT           : return "OP_ESHADOWMINT";
    case OP_ESHADOWSPEND          : return "OP_ESHADOWSPEND";
    case OP_ESHADOWPUBLICSPEND    : return "OP_ESHADOWPUBLICSPEND";
...
bool CScript::IsEshadowMint() const
{
    return StartsWithOpcode(OP_ESHADOWMINT);
}

bool CScript::IsEshadowSpend() const
{
    return StartsWithOpcode(OP_ESHADOWSPEND);
}

bool CScript::IsEshadowPublicSpend() const
{
    return StartsWithOpcode(OP_ESHADOWPUBLICSPEND);
}
