...
// Copyright (c) 2015-2019 The OZEETY developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OZEETY_SERIALIZE_H
#define OZEETY_SERIALIZE_H
...
// Serializatin for libeshadow::CoinDenomination
template <typename Stream>
inline void Serialize(Stream& s, libeshadow::CoinDenomination a)
{
    int f = libeshadow::EshadowDenominationToInt(a);
    ser_writedata32(s, f);
}

template <typename Stream>
inline void Unserialize(Stream& s, libeshadow::CoinDenomination& a)
{
    int f = ser_readdata32(s);
    a = libeshadow::IntToEshadowDenomination(f);
}

// Serialization for libeshadow::SpendType
template <typename Stream>
inline void Serialize(Stream& s, libeshadow::SpendType a)
{
...
template <typename Stream>
inline void Unserialize(Stream& s, libeshadow::SpendType & a)
{
    uint8_t f = ser_readdata8(s);
    a = static_cast<libeshadow::SpendType>(f);
}
