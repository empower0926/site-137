...
class BudgetProposalTest(OzeetyTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid OZEETY address")
        assert_raises_rpc_error(-5, "Invalid OZEETY address", self.nodes[0].preparebudget,
